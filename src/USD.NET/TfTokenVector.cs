...
public class TfTokenVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<TfToken>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_TfTokenVector(swigCPtr);
        }
  ...
  public void Clear() {
    USDIPCPINVOKE.TfTokenVector_Clear(swigCPtr);
  }

  public void Add(TfToken x) {
    USDIPCPINVOKE.TfTokenVector_Add(swigCPtr, TfToken.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = USDIPCPINVOKE.TfTokenVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = USDIPCPINVOKE.TfTokenVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    USDIPCPINVOKE.TfTokenVector_reserve(swigCPtr, n);
  }

  public TfTokenVector() : this(USDIPCPINVOKE.new_TfTokenVector__SWIG_0(), true) {
  }

  public TfTokenVector(TfTokenVector other) : this(USDIPCPINVOKE.new_TfTokenVector__SWIG_1(TfTokenVector.getCPtr(other)), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public TfTokenVector(int capacity) : this(USDIPCPINVOKE.new_TfTokenVector__SWIG_2(capacity), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private TfToken getitemcopy(int index) {
    TfToken ret = new TfToken(USDIPCPINVOKE.TfTokenVector_getitemcopy(swigCPtr, index), true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private TfToken getitem(int index) {
    TfToken ret = new TfToken(USDIPCPINVOKE.TfTokenVector_getitem(swigCPtr, index), false);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, TfToken val) {
    USDIPCPINVOKE.TfTokenVector_setitem(swigCPtr, index, TfToken.getCPtr(val));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(TfTokenVector values) {
    USDIPCPINVOKE.TfTokenVector_AddRange(swigCPtr, TfTokenVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public TfTokenVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.TfTokenVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, TfToken x) {
    USDIPCPINVOKE.TfTokenVector_Insert(swigCPtr, index, TfToken.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, TfTokenVector values) {
    USDIPCPINVOKE.TfTokenVector_InsertRange(swigCPtr, index, TfTokenVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    USDIPCPINVOKE.TfTokenVector_RemoveAt(swigCPtr, index);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    USDIPCPINVOKE.TfTokenVector_RemoveRange(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public static TfTokenVector Repeat(TfToken value, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.TfTokenVector_Repeat(TfToken.getCPtr(value), count);
    TfTokenVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new TfTokenVector(cPtr, true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    USDIPCPINVOKE.TfTokenVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    USDIPCPINVOKE.TfTokenVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, TfTokenVector values) {
    USDIPCPINVOKE.TfTokenVector_SetRange(swigCPtr, index, TfTokenVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }
