...
public class GfVec3dVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<GfVec3d>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_GfVec3dVector(swigCPtr);
        }
  ...
  public void Clear() {
    USDIPCPINVOKE.GfVec3dVector_Clear(swigCPtr);
  }

  public void Add(GfVec3d x) {
    USDIPCPINVOKE.GfVec3dVector_Add(swigCPtr, GfVec3d.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = USDIPCPINVOKE.GfVec3dVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = USDIPCPINVOKE.GfVec3dVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    USDIPCPINVOKE.GfVec3dVector_reserve(swigCPtr, n);
  }

  public GfVec3dVector() : this(USDIPCPINVOKE.new_GfVec3dVector__SWIG_0(), true) {
  }

  public GfVec3dVector(GfVec3dVector other) : this(USDIPCPINVOKE.new_GfVec3dVector__SWIG_1(GfVec3dVector.getCPtr(other)), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public GfVec3dVector(int capacity) : this(USDIPCPINVOKE.new_GfVec3dVector__SWIG_2(capacity), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private GfVec3d getitemcopy(int index) {
    GfVec3d ret = new GfVec3d(USDIPCPINVOKE.GfVec3dVector_getitemcopy(swigCPtr, index), true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private GfVec3d getitem(int index) {
    GfVec3d ret = new GfVec3d(USDIPCPINVOKE.GfVec3dVector_getitem(swigCPtr, index), false);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, GfVec3d val) {
    USDIPCPINVOKE.GfVec3dVector_setitem(swigCPtr, index, GfVec3d.getCPtr(val));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(GfVec3dVector values) {
    USDIPCPINVOKE.GfVec3dVector_AddRange(swigCPtr, GfVec3dVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public GfVec3dVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.GfVec3dVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, GfVec3d x) {
    USDIPCPINVOKE.GfVec3dVector_Insert(swigCPtr, index, GfVec3d.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, GfVec3dVector values) {
    USDIPCPINVOKE.GfVec3dVector_InsertRange(swigCPtr, index, GfVec3dVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    USDIPCPINVOKE.GfVec3dVector_RemoveAt(swigCPtr, index);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    USDIPCPINVOKE.GfVec3dVector_RemoveRange(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public static GfVec3dVector Repeat(GfVec3d value, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.GfVec3dVector_Repeat(GfVec3d.getCPtr(value), count);
    GfVec3dVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new GfVec3dVector(cPtr, true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    USDIPCPINVOKE.GfVec3dVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    USDIPCPINVOKE.GfVec3dVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, GfVec3dVector values) {
    USDIPCPINVOKE.GfVec3dVector_SetRange(swigCPtr, index, GfVec3dVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }
