...
public class UsdPrimVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<UsdPrim>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_UsdPrimVector(swigCPtr);
        }
  ...
  public void Clear() {
    USDIPCPINVOKE.UsdPrimVector_Clear(swigCPtr);
  }

  public void Add(UsdPrim x) {
    USDIPCPINVOKE.UsdPrimVector_Add(swigCPtr, UsdPrim.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = USDIPCPINVOKE.UsdPrimVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = USDIPCPINVOKE.UsdPrimVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    USDIPCPINVOKE.UsdPrimVector_reserve(swigCPtr, n);
  }

  public UsdPrimVector() : this(USDIPCPINVOKE.new_UsdPrimVector__SWIG_0(), true) {
  }

  public UsdPrimVector(UsdPrimVector other) : this(USDIPCPINVOKE.new_UsdPrimVector__SWIG_1(UsdPrimVector.getCPtr(other)), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public UsdPrimVector(int capacity) : this(USDIPCPINVOKE.new_UsdPrimVector__SWIG_2(capacity), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private UsdPrim getitemcopy(int index) {
    UsdPrim ret = new UsdPrim(USDIPCPINVOKE.UsdPrimVector_getitemcopy(swigCPtr, index), true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private UsdPrim getitem(int index) {
    UsdPrim ret = new UsdPrim(USDIPCPINVOKE.UsdPrimVector_getitem(swigCPtr, index), false);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, UsdPrim val) {
    USDIPCPINVOKE.UsdPrimVector_setitem(swigCPtr, index, UsdPrim.getCPtr(val));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(UsdPrimVector values) {
    USDIPCPINVOKE.UsdPrimVector_AddRange(swigCPtr, UsdPrimVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public UsdPrimVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.UsdPrimVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, UsdPrim x) {
    USDIPCPINVOKE.UsdPrimVector_Insert(swigCPtr, index, UsdPrim.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, UsdPrimVector values) {
    USDIPCPINVOKE.UsdPrimVector_InsertRange(swigCPtr, index, UsdPrimVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    USDIPCPINVOKE.UsdPrimVector_RemoveAt(swigCPtr, index);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    USDIPCPINVOKE.UsdPrimVector_RemoveRange(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public static UsdPrimVector Repeat(UsdPrim value, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.UsdPrimVector_Repeat(UsdPrim.getCPtr(value), count);
    UsdPrimVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new UsdPrimVector(cPtr, true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    USDIPCPINVOKE.UsdPrimVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    USDIPCPINVOKE.UsdPrimVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, UsdPrimVector values) {
    USDIPCPINVOKE.UsdPrimVector_SetRange(swigCPtr, index, UsdPrimVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }
