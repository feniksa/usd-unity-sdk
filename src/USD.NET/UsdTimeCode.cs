...
public class UsdTimeCode : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_UsdTimeCode(swigCPtr);
        }
  ...
  public UsdTimeCode(double t) : this(USDIPCPINVOKE.new_UsdTimeCode__SWIG_0(t), true) {
  }

  public UsdTimeCode() : this(USDIPCPINVOKE.new_UsdTimeCode__SWIG_1(), true) {
  }

  public static UsdTimeCode EarliestTime() {
    UsdTimeCode ret = new UsdTimeCode(USDIPCPINVOKE.UsdTimeCode_EarliestTime(), true);
    return ret;
  }

  public static UsdTimeCode Default() {
    UsdTimeCode ret = new UsdTimeCode(USDIPCPINVOKE.UsdTimeCode_Default(), true);
    return ret;
  }

  public static double SafeStep(double maxValue, double maxCompression) {
    double ret = USDIPCPINVOKE.UsdTimeCode_SafeStep__SWIG_0(maxValue, maxCompression);
    return ret;
  }

  public static double SafeStep(double maxValue) {
    double ret = USDIPCPINVOKE.UsdTimeCode_SafeStep__SWIG_1(maxValue);
    return ret;
  }

  public static double SafeStep() {
    double ret = USDIPCPINVOKE.UsdTimeCode_SafeStep__SWIG_2();
    return ret;
  }

  public bool IsDefault() {
    bool ret = USDIPCPINVOKE.UsdTimeCode_IsDefault(swigCPtr);
    return ret;
  }

  public bool IsNumeric() {
    bool ret = USDIPCPINVOKE.UsdTimeCode_IsNumeric(swigCPtr);
    return ret;
  }

  public double GetValue() {
    double ret = USDIPCPINVOKE.UsdTimeCode_GetValue(swigCPtr);
    return ret;
  }
