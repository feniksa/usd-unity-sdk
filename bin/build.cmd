...
swig.exe -w401 -w516 -w503 -DAR_VERSION=2 -namespace pxr -I%USD_LOCATION%\include -I.\src\UsdCs\ -I.\ -c++ -csharp -outdir .\src\USD.NET -o .\src\UsdCs\usdCs_wrap.cpp .\src\Swig\UsdCs.i
IF NOT %ERRORLEVEL% == 0 (
