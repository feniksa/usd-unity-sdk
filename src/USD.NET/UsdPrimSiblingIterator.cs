...
public class UsdPrimSiblingIterator : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_UsdPrimSiblingIterator(swigCPtr);
        }
  ...
  public void MoveNext() {
    USDIPCPINVOKE.UsdPrimSiblingIterator_MoveNext(swigCPtr);
  }

  public UsdPrim GetCurrent() {
    UsdPrim ret = new UsdPrim(USDIPCPINVOKE.UsdPrimSiblingIterator_GetCurrent(swigCPtr), true);
    return ret;
  }

  public static bool Equals(UsdPrimSiblingIterator lhs, UsdPrimSiblingIterator rhs) {
    bool ret = USDIPCPINVOKE.UsdPrimSiblingIterator_Equals(UsdPrimSiblingIterator.getCPtr(lhs), UsdPrimSiblingIterator.getCPtr(rhs));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  override public int GetHashCode() {
    int ret = USDIPCPINVOKE.UsdPrimSiblingIterator_GetHashCode(swigCPtr);
    return ret;
  }
  ...
  public UsdPrimSiblingIterator() : this(USDIPCPINVOKE.new_UsdPrimSiblingIterator(), true) {
  }
