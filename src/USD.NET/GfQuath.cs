...
public class GfQuath : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_GfQuath(swigCPtr);
        }
  ...
  public static bool Equals(GfQuath lhs, GfQuath rhs) {
    bool ret = USDIPCPINVOKE.GfQuath_Equals(GfQuath.getCPtr(lhs), GfQuath.getCPtr(rhs));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  override public int GetHashCode() {
    int ret = USDIPCPINVOKE.GfQuath_GetHashCode(swigCPtr);
    return ret;
  }
  ...
  public GfQuath() : this(USDIPCPINVOKE.new_GfQuath(), true) {
  }
