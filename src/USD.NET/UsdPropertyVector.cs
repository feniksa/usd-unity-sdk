...
public class UsdPropertyVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<UsdProperty>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_UsdPropertyVector(swigCPtr);
        }
  ...
  public void Clear() {
    USDIPCPINVOKE.UsdPropertyVector_Clear(swigCPtr);
  }

  public void Add(UsdProperty x) {
    USDIPCPINVOKE.UsdPropertyVector_Add(swigCPtr, UsdProperty.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = USDIPCPINVOKE.UsdPropertyVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = USDIPCPINVOKE.UsdPropertyVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    USDIPCPINVOKE.UsdPropertyVector_reserve(swigCPtr, n);
  }

  public UsdPropertyVector() : this(USDIPCPINVOKE.new_UsdPropertyVector__SWIG_0(), true) {
  }

  public UsdPropertyVector(UsdPropertyVector other) : this(USDIPCPINVOKE.new_UsdPropertyVector__SWIG_1(UsdPropertyVector.getCPtr(other)), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public UsdPropertyVector(int capacity) : this(USDIPCPINVOKE.new_UsdPropertyVector__SWIG_2(capacity), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private UsdProperty getitemcopy(int index) {
    UsdProperty ret = new UsdProperty(USDIPCPINVOKE.UsdPropertyVector_getitemcopy(swigCPtr, index), true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private UsdProperty getitem(int index) {
    UsdProperty ret = new UsdProperty(USDIPCPINVOKE.UsdPropertyVector_getitem(swigCPtr, index), false);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, UsdProperty val) {
    USDIPCPINVOKE.UsdPropertyVector_setitem(swigCPtr, index, UsdProperty.getCPtr(val));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(UsdPropertyVector values) {
    USDIPCPINVOKE.UsdPropertyVector_AddRange(swigCPtr, UsdPropertyVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public UsdPropertyVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.UsdPropertyVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, UsdProperty x) {
    USDIPCPINVOKE.UsdPropertyVector_Insert(swigCPtr, index, UsdProperty.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, UsdPropertyVector values) {
    USDIPCPINVOKE.UsdPropertyVector_InsertRange(swigCPtr, index, UsdPropertyVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    USDIPCPINVOKE.UsdPropertyVector_RemoveAt(swigCPtr, index);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    USDIPCPINVOKE.UsdPropertyVector_RemoveRange(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public static UsdPropertyVector Repeat(UsdProperty value, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.UsdPropertyVector_Repeat(UsdProperty.getCPtr(value), count);
    UsdPropertyVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new UsdPropertyVector(cPtr, true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    USDIPCPINVOKE.UsdPropertyVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    USDIPCPINVOKE.UsdPropertyVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, UsdPropertyVector values) {
    USDIPCPINVOKE.UsdPropertyVector_SetRange(swigCPtr, index, UsdPropertyVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }
