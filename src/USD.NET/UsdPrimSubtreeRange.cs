...
public class UsdPrimSubtreeRange : 
    ...
    global::System.Collections.Generic.IEnumerable<UsdPrim>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_UsdPrimSubtreeRange(swigCPtr);
        }
  ...
  public UsdPrimSubtreeIterator begin() {
    UsdPrimSubtreeIterator ret = new UsdPrimSubtreeIterator(USDIPCPINVOKE.UsdPrimSubtreeRange_begin(swigCPtr), true);
    return ret;
  }

  public UsdPrimSubtreeIterator end() {
    UsdPrimSubtreeIterator ret = new UsdPrimSubtreeIterator(USDIPCPINVOKE.UsdPrimSubtreeRange_end(swigCPtr), true);
    return ret;
  }

  public UsdPrimSubtreeIterator GetStart() {
    UsdPrimSubtreeIterator ret = new UsdPrimSubtreeIterator(USDIPCPINVOKE.UsdPrimSubtreeRange_GetStart(swigCPtr), true);
    return ret;
  }

  public UsdPrimSubtreeIterator GetEnd() {
    UsdPrimSubtreeIterator ret = new UsdPrimSubtreeIterator(USDIPCPINVOKE.UsdPrimSubtreeRange_GetEnd(swigCPtr), true);
    return ret;
  }

  public UsdPrimSubtreeRange() : this(USDIPCPINVOKE.new_UsdPrimSubtreeRange(), true) {
  }
