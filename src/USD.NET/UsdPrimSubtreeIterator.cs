...
public class UsdPrimSubtreeIterator : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_UsdPrimSubtreeIterator(swigCPtr);
        }
  ...
  public void MoveNext() {
    USDIPCPINVOKE.UsdPrimSubtreeIterator_MoveNext(swigCPtr);
  }

  public UsdPrim GetCurrent() {
    UsdPrim ret = new UsdPrim(USDIPCPINVOKE.UsdPrimSubtreeIterator_GetCurrent(swigCPtr), true);
    return ret;
  }

  public static bool Equals(UsdPrimSubtreeIterator lhs, UsdPrimSubtreeIterator rhs) {
    bool ret = USDIPCPINVOKE.UsdPrimSubtreeIterator_Equals(UsdPrimSubtreeIterator.getCPtr(lhs), UsdPrimSubtreeIterator.getCPtr(rhs));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  override public int GetHashCode() {
    int ret = USDIPCPINVOKE.UsdPrimSubtreeIterator_GetHashCode(swigCPtr);
    return ret;
  }
  ...
  public UsdPrimSubtreeIterator() : this(USDIPCPINVOKE.new_UsdPrimSubtreeIterator(), true) {
  }
