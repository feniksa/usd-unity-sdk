...
public class TfTypeVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<TfType>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_TfTypeVector(swigCPtr);
        }
  ...
  public void Clear() {
    USDIPCPINVOKE.TfTypeVector_Clear(swigCPtr);
  }

  public void Add(TfType x) {
    USDIPCPINVOKE.TfTypeVector_Add(swigCPtr, TfType.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = USDIPCPINVOKE.TfTypeVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = USDIPCPINVOKE.TfTypeVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    USDIPCPINVOKE.TfTypeVector_reserve(swigCPtr, n);
  }

  public TfTypeVector() : this(USDIPCPINVOKE.new_TfTypeVector__SWIG_0(), true) {
  }

  public TfTypeVector(TfTypeVector other) : this(USDIPCPINVOKE.new_TfTypeVector__SWIG_1(TfTypeVector.getCPtr(other)), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public TfTypeVector(int capacity) : this(USDIPCPINVOKE.new_TfTypeVector__SWIG_2(capacity), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private TfType getitemcopy(int index) {
    TfType ret = new TfType(USDIPCPINVOKE.TfTypeVector_getitemcopy(swigCPtr, index), true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private TfType getitem(int index) {
    TfType ret = new TfType(USDIPCPINVOKE.TfTypeVector_getitem(swigCPtr, index), false);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, TfType val) {
    USDIPCPINVOKE.TfTypeVector_setitem(swigCPtr, index, TfType.getCPtr(val));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(TfTypeVector values) {
    USDIPCPINVOKE.TfTypeVector_AddRange(swigCPtr, TfTypeVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public TfTypeVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.TfTypeVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, TfType x) {
    USDIPCPINVOKE.TfTypeVector_Insert(swigCPtr, index, TfType.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, TfTypeVector values) {
    USDIPCPINVOKE.TfTypeVector_InsertRange(swigCPtr, index, TfTypeVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    USDIPCPINVOKE.TfTypeVector_RemoveAt(swigCPtr, index);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    USDIPCPINVOKE.TfTypeVector_RemoveRange(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public static TfTypeVector Repeat(TfType value, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.TfTypeVector_Repeat(TfType.getCPtr(value), count);
    TfTypeVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new TfTypeVector(cPtr, true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    USDIPCPINVOKE.TfTypeVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    USDIPCPINVOKE.TfTypeVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, TfTypeVector values) {
    USDIPCPINVOKE.TfTypeVector_SetRange(swigCPtr, index, TfTypeVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }
