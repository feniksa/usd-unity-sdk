...
public class UsdStageCacheRequest : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_UsdStageCacheRequest(swigCPtr);
        }
  ...
  public virtual bool IsSatisfiedBy(UsdStage stage) {
    bool ret = USDIPCPINVOKE.UsdStageCacheRequest_IsSatisfiedBy__SWIG_0(swigCPtr, UsdStage.getCPtr(stage));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool IsSatisfiedBy(UsdStageCacheRequest pending) {
    bool ret = USDIPCPINVOKE.UsdStageCacheRequest_IsSatisfiedBy__SWIG_1(swigCPtr, UsdStageCacheRequest.getCPtr(pending));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual UsdStage Manufacture() {
    global::System.IntPtr cPtr = USDIPCPINVOKE.UsdStageCacheRequest_Manufacture(swigCPtr);
