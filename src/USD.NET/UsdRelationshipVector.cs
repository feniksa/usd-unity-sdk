...
public class UsdRelationshipVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<UsdRelationship>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          USDIPCPINVOKE.delete_UsdRelationshipVector(swigCPtr);
        }
  ...
  public void Clear() {
    USDIPCPINVOKE.UsdRelationshipVector_Clear(swigCPtr);
  }

  public void Add(UsdRelationship x) {
    USDIPCPINVOKE.UsdRelationshipVector_Add(swigCPtr, UsdRelationship.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = USDIPCPINVOKE.UsdRelationshipVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = USDIPCPINVOKE.UsdRelationshipVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    USDIPCPINVOKE.UsdRelationshipVector_reserve(swigCPtr, n);
  }

  public UsdRelationshipVector() : this(USDIPCPINVOKE.new_UsdRelationshipVector__SWIG_0(), true) {
  }

  public UsdRelationshipVector(UsdRelationshipVector other) : this(USDIPCPINVOKE.new_UsdRelationshipVector__SWIG_1(UsdRelationshipVector.getCPtr(other)), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public UsdRelationshipVector(int capacity) : this(USDIPCPINVOKE.new_UsdRelationshipVector__SWIG_2(capacity), true) {
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  private UsdRelationship getitemcopy(int index) {
    UsdRelationship ret = new UsdRelationship(USDIPCPINVOKE.UsdRelationshipVector_getitemcopy(swigCPtr, index), true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private UsdRelationship getitem(int index) {
    UsdRelationship ret = new UsdRelationship(USDIPCPINVOKE.UsdRelationshipVector_getitem(swigCPtr, index), false);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, UsdRelationship val) {
    USDIPCPINVOKE.UsdRelationshipVector_setitem(swigCPtr, index, UsdRelationship.getCPtr(val));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(UsdRelationshipVector values) {
    USDIPCPINVOKE.UsdRelationshipVector_AddRange(swigCPtr, UsdRelationshipVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public UsdRelationshipVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.UsdRelationshipVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, UsdRelationship x) {
    USDIPCPINVOKE.UsdRelationshipVector_Insert(swigCPtr, index, UsdRelationship.getCPtr(x));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, UsdRelationshipVector values) {
    USDIPCPINVOKE.UsdRelationshipVector_InsertRange(swigCPtr, index, UsdRelationshipVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    USDIPCPINVOKE.UsdRelationshipVector_RemoveAt(swigCPtr, index);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    USDIPCPINVOKE.UsdRelationshipVector_RemoveRange(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public static UsdRelationshipVector Repeat(UsdRelationship value, int count) {
    global::System.IntPtr cPtr = USDIPCPINVOKE.UsdRelationshipVector_Repeat(UsdRelationship.getCPtr(value), count);
    UsdRelationshipVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new UsdRelationshipVector(cPtr, true);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    USDIPCPINVOKE.UsdRelationshipVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    USDIPCPINVOKE.UsdRelationshipVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, UsdRelationshipVector values) {
    USDIPCPINVOKE.UsdRelationshipVector_SetRange(swigCPtr, index, UsdRelationshipVector.getCPtr(values));
    if (USDIPCPINVOKE.SWIGPendingException.Pending) throw USDIPCPINVOKE.SWIGPendingException.Retrieve();
  }
